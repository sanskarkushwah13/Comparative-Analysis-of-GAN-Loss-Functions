...
python src/train.py --loss wgangp --dataset cifar10 --epochs 200

# Train the Hybrid loss on CheXpert (3 seeds for robustness)
python src/train.py --loss hybrid --dataset chexpert --epochs 200 --seeds 42 123 7

# Run the full benchmark (all 6 × 3 combinations)
python src/train.py --all --epochs 200
